...
public class DivTranslator implements InsnTranslator {
  ...
  public void translate (final TranslationCtx env, final Instruction instruction, final List<LowLevelRReil> instructions) {
    ...
    switch (size) {
      case 8: {
        ...
        instructions.addAll(
            Arrays.asList(
                factory.CONVERT(env.getNextReilAddress(), t, divisor),
                factory.DIVU(env.getNextReilAddress(), q, ax, t),
                factory.MOD(env.getNextReilAddress(), r, ax, t),
                factory.MOV(env.getNextReilAddress(), ah, r.withSize(OperandSize.BYTE.getBits())),
                factory.MOV(env.getNextReilAddress(), al, q.withSize(OperandSize.BYTE.getBits()))));
      }
      break;
      case 16: {
        // DX:AX
        ...
        instructions.addAll(
            Arrays.asList(
                ...
                factory.DIVU(env.getNextReilAddress(), q, src, t),
