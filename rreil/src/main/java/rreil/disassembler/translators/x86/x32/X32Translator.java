 ...
 * @author mb0
 */
public class X32Translator implements Translator {
  private static LowLevelRReilFactory factory = LowLevelRReilFactory.getInstance();

  public static final X32Translator $ = new X32Translator();
  ...
  static {
    ...
    translators.put("fnop", new NopTranslator());
    ...
    translators.put("jnbe", new JccTranslator(X86Conditions.ABOVE));
    ...
    translators.put("jnl", new JccTranslator(X86Conditions.GREATER_OR_EQUAL));
   ...
   */
  public List<LowLevelRReil> translateRReil (TranslationCtx ctx, Instruction insn) throws TranslationException {
  ...
  @Override public List<LowLevelRReil> translate (TranslationCtx ctx, Instruction instruction) throws TranslationException {
