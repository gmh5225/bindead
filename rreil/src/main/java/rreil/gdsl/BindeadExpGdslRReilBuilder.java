...
import rreil.gdsl.exp_builder.ExceptionBuilder;
import rreil.gdsl.exp_builder.FlopOpBuilder;
import rreil.gdsl.exp_builder.StatementCollectionBuilder;
import rreil.gdsl.exp_builder.expression.ExpressionBuilder;
import rreil.gdsl.exp_builder.expression.ExpressionSexprBuilder;
import rreil.gdsl.exp_builder.expression.ExtensionBuilder;
import rreil.gdsl.exp_builder.linear.BinopBuilder;
import rreil.gdsl.exp_builder.linear.LinearBuilder;
import rreil.gdsl.exp_builder.linear.LinearVariableBuilder;
import rreil.gdsl.exp_builder.linear.LiteralBuilder;
import rreil.gdsl.exp_builder.linear.ScaleBuilder;
import rreil.gdsl.exp_builder.sexpr.ArbitraryBuilder;
import rreil.gdsl.exp_builder.sexpr.SexprBuilder;
import rreil.gdsl.exp_builder.sexpr.SexprCompareBuilder;
import rreil.gdsl.exp_builder.sexpr.SexprLinearBuilder;
import rreil.gdsl.exp_builder.statement.AssignBuilder;
import rreil.gdsl.exp_builder.statement.BranchBuilder;
import rreil.gdsl.exp_builder.statement.ConditionalBranchBuilder;
import rreil.gdsl.exp_builder.statement.FlopBuilder;
import rreil.gdsl.exp_builder.statement.IteBuilder;
import rreil.gdsl.exp_builder.statement.LoadBuilder;
import rreil.gdsl.exp_builder.statement.PrimitiveBuilder;
import rreil.gdsl.exp_builder.statement.StoreBuilder;
import rreil.gdsl.exp_builder.statement.ThrowBuilder;
import rreil.gdsl.exp_builder.statement.WhileBuilder;
 ...
 * @author Julian Kranz
 */
public class BindeadExpGdslRReilBuilder implements IRReilBuilder {
   ...
   */
  public BindeadExpGdslRReilBuilder (RReilAddr address) {
   ...
   */
  public BindeadExpGdslRReilBuilder () {
  ...
  @Override public IExpression sem_mul (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Mul,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_div (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Divu,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_divs (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Divs,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_mod (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Mod,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_mods (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Mods,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_shl (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Shl,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_shr (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Shr,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_shrs (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Shrs,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_and (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.And,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_or (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Or,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }

  @Override public IExpression sem_xor (ILinearExpression lhs, ILinearExpression rhs) {
    return new rreil.gdsl.exp_builder.expression.BinopBuilder(manager, BinOp.Xor,
      (LinearBuilder) lhs, (LinearBuilder) rhs);
  }
