 ...
 * FIXME: see if we even need the origins and such. If not remove and let the threshold be only a test.
 * FIXME: currently we distinguish thresholds by their origin. See if this is a problem.
 */
