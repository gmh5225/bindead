 ...
 * offset.
 */
public class WriteToXrefWithNonConstantOffsetWarning extends WarningMessage.Info {
  private static final String fmt = "Write to xref: %s with non-constant offset: %s";
  private final AbstractMemPointer location;
  private final Range offset;

  public WriteToXrefWithNonConstantOffsetWarning (AbstractMemPointer location, Range offset) {
